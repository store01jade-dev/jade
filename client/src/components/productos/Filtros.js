...
export default function Filtros({ filtros, setFiltros }) {
    ...
    useEffect(() => {
        const fetchCategorias = async () => {
            try {
                const response = await fetch('http://localhost:4000/api/v1/categorias');
                if (response.ok) {
                ...
                <div className={styles.precioRangeWrapper}> 
                    <div className={styles.filtroItem}>
                        ...
                        <input
                            ...
                            // CRÍTICO: Asegura que el valor sea un número o cero
                    ...
                    <div className={styles.filtroItem}>
                        ...
                        <input
                            ...
                            // CRÍTICO: Asegura que el valor sea un número o un valor por defecto alto
...
// Añade los estilos .actionButtons, .aplicarBtn y .limpiarBtn a tu Filtros.module.css